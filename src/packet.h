...
public:
     ...
     */
    void attribute_deprecated setPts(int64_t pts,     const Rational &tsTimeBase = Rational(0, 0));
    void attribute_deprecated setDts(int64_t dts,     const Rational &tsTimeBase = Rational(0, 0));
